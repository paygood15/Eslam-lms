...
import { updateCategory,fetchCategoryById } from "../../store/CaregorySlice1";
...
const EditClasses = () => {
  ...
  const { isLoading ,category} = useSelector((state) => state.CaategorySlice1);
console.log(category);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(updateCategory({ id, data: { name } })) 
      .then(() => {
