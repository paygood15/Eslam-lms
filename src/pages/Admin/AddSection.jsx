...
import { createSection } from "../../store/SectionSlice";
...
const AddSection = () => {
    ...
    const { loading } = useSelector((state) => state.SectionSlice);
    ...
    const handleSubmit = (e) => {
      ...
      dispatch(createSection({ name,description,categoryId }))
        .then(() => {
  ...
  return (
    ...
    <div className="main-title flex justify-between items-center p-5">
      <h3 className="text-[18px] font-bold">Add Section</h3>
      <p className="text-[#67748E]">Pages / Add Section</p>
    </div>
    <div className="Add-Class">
      <form onSubmit={handleSubmit}>
        <div className="grid p-5 gap-2 mb-1 md:grid-cols-2">
          ...
          <div>
          <label htmlFor="category" className="block mb-1 text-sm font-medium">Class</label>
                  <select
                    id="categories"
